                ...
                <div class="tab-menu-heading tab-menu-heading-boxed">
                    <div class="tabs-menu-boxed">
                        ...
                        <ul class="nav panel-tabs">
                            <li><a href="#" class="active">Jumlah Pengalaman Data</a></li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <form action="{{ route('count.update', $count->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-12 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom01" name="judul" value="{{ $count->judul }}">
                                                <div class="valid-feedback">Looks good!</div>
                                            </div>
                                            <div class="col-xl-12 mb-3">
                                                <label for="validationCustom01">angka</label>
                                                <input type="text" class="form-control" id="validationCustom01" name="angka" value="{{ $count->angka }}">
                                                <div class="valid-feedback">Looks good!</div>
                                            </div>
                                        </div>
