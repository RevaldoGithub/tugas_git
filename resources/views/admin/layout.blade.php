                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('bgb')" data-bs-toggle="slide" href="{{route('banner.index')}}"><i class="side-menu__icon fa fa-image"></i><span class="side-menu__label">Banner Hedder</span></a>
                            </li>
                            <li class="slide">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('count.index')}}"><i class="side-menu__icon fa fa-clock-o"></i><span class="side-menu__label">Jumlah Pengalaman</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('job.index')}}"><i class="side-menu__icon fa fa-laptop"></i><span class="side-menu__label">Job</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('pengalaman.index')}}"><i class="side-menu__icon fa fa-building"></i><span class="side-menu__label">Riwayat Pengalaman</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('sekolah.index')}}"><i class="side-menu__icon fa fa-mortar-board"></i><span class="side-menu__label">Riwayat Sekolah</span></a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('porto.index')}}"><i class="side-menu__icon fa fa-image"></i><span class="side-menu__label">Portfolio</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('profesi.index')}}"><i class="side-menu__icon fa fa-building"></i><span class="side-menu__label">Profesi</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('persen.index')}}"><i class="side-menu__icon fa fa-safari"></i><span class="side-menu__label">Persen Data</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('contact.index')}}"><i class="side-menu__icon fa fa-phone-square"></i><span class="side-menu__label">Contact</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link  @yield('about')" data-bs-toggle="slide" href="{{route('form_contact.index')}}"><i class="side-menu__icon fa fa-envelope"></i><span class="side-menu__label">Form Contact Person</span></a>
                            </li>
                            <li class="sub-category">
                                <h3>Configuration</h3>
                            </li>
